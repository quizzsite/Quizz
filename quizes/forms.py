...
class MaterialForm(forms.ModelForm):
    class Meta:
        model = Material
        fields = ['name', 'text']
        widgets = {'text': SummernoteWidget(attrs={'class': 'form-control item'}), "timeout": forms.NumberInput(attrs={'class': 'form-input form-control item', 'width': 'auto', 'height': 'auto', 'min': 0})}